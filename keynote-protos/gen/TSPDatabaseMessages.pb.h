...
class DatabaseDataArchive final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_app_relative_path();
  ...
  PROTOBUF_MUST_USE_RESULT ::TSP::Reference* release_data();
...
class DatabaseImageDataArchive final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::TSP::DatabaseDataArchive* release_super();
...
void DatabaseDataArchive::set_app_relative_path(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 app_relative_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void DatabaseDataArchive::_internal_set_app_relative_path(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  app_relative_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* DatabaseDataArchive::_internal_mutable_app_relative_path() {
  _has_bits_[0] |= 0x00000001u;
  return app_relative_path_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* DatabaseDataArchive::release_app_relative_path() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return app_relative_path_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline void DatabaseImageDataArchive::set_allocated_super(::TSP::DatabaseDataArchive* super) {
  ...
  if (super) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TSP::DatabaseDataArchive>::GetOwningArena(super);
    if (message_arena != submessage_arena) {
