...
class FixCorruptedDataCommandArchive PROTOBUF_FINAL :
 ...
 public:
  ...
  inline FixCorruptedDataCommandArchive* New() const final {
    return CreateMaybeMessage<FixCorruptedDataCommandArchive>(nullptr);
  }
...
inline std::string* FixCorruptedDataCommandArchive::add_corrupted_digest_list() {
  ...
  return _internal_add_corrupted_digest_list();
}
